...
import {faPumpSoap, faCouch, faUtensils, faLaptop, faShirt, faShoePrints, faChargingStation, faMotorcycle, faMobileAlt, faDumbbell, faTabletAlt, faTshirt, faCar, faClock, faStore, faBagShopping, faBasketShopping, faGem } from '@fortawesome/free-solid-svg-icons'; // Import icons
        ...
        {allCategories &&
          allCategories.map((category) => (
            <div
              ...
              onClick={() => window.location.href = `/category/${category.slug}`} // Convert to button action
            >
              <FontAwesomeIcon icon={categoryIcons[category.name as keyof typeof categoryIcons] || categoryIcons.Default} className="mb-2" size="2x" /> 
